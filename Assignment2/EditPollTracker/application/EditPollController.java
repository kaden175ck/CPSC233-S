...
public class EditPollController extends PollTrackerController {
    ...
    void updatePartyClick(ActionEvent event) {			//event that will update party 
    	// get seleected item from choice box
    	//  you should have a party object from the selected item
    	// if selected party is not nuull thn 
//    	//	do following 
//    			get projected seats from text field
//    			get projected percentage from text field 
//    			use party object to set number seats
//    			use party object to set projected percentage of vote
//    			update selected party object to poll
//    			and call referesh method 
    	...
    	if(partyToEdit != null && isValidSeats(projectedNumOfSeatsTextField) == true && 
    		...
    		System.out.println(partyToEdit.toString());
		...
		pollToEditBox.getSelectionModel().selectedIndexProperty().addListener(
        		new	ChangeListener<Number>() {
            		...
            		public void changed(ObservableValue observable, Number oldValue, Number newValue) {
            			Poll pollToUpdate = polls[newValue.intValue()];			//poll to update is based on the index of choicebox
