...
public class PollTest {
	...
	@Test
	public void test_getPartiesSortedBySeats() throws InvalidPartyDataException {
	...
	@Test
	public void test_getPartiesSortedByVotes() throws InvalidPartyDataException {
		Poll p = new Poll("poll1", 5);
	...
	@Test
	public void test_addParty_PollFullException() {
		Poll p = new Poll("Poll Test", 2);
		Party p1 = new MockParty("PartyOne");
		Party p2 = new MockParty("Party Two");
		Party p3 = new MockParty("Party Three");
		try {
			p.addParty(p1);
		} catch (PollFullException e) {
			// TODO Auto-generated catch block
		...
		assertEquals("The full poll has two parties, expected number of parties to be two", 2, p.getNumberOfParties());
	}
