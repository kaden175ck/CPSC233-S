...
public class Poll {
	...
	public void addParty(Party aParty) throws PollFullException {
		...
		//Add aParty to the end of the list if the array still has room. And create a new throw exception named PollFullException.
		if(numberOfParties < parties.length){
			...
			throw new PollFullException("The current poll is full.");
		}
	}
...
class sortPartiesComparator implements Comparator<Party> {
	...
	/**
	  ...
	  */
	@Override
	public int compare(Party o1, Party o2) throws NullPointerException{
