	...
	public Poll getAggregatePoll(String[] partyNames){
		...
		for (int index = 0; index < partyNames.length; index++) {
			try {
				...
				/*
				 * Using try chtch because if the PullFullExxception would be threw, then this catch statement would get the exception and print out the exception message.
				 */
