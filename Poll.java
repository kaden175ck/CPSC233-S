...
public class Poll {
	...
	public void addParty(Party aParty) {
		...
		//If aParty has the same name as another party all ready in the parties array, then the existing party should be replaced by aParty.
		int replaceHappened = 0;//This is a counter to record the time of replacement.
